...
export default function Sidebar() {
  ...
  return (
    <aside className={cn(
      'shrink-0 bg-white flex flex-col shadow-[2px_0_12px_rgba(0,0,0,0.04)] transition-[width] duration-200',
      isChat ? 'w-64' : 'w-56',
    )}>
      ...
      <nav className="py-4 px-2.5 space-y-5 shrink-0">
      ...
      {isChat && (
        <>
          <div className="mx-3 border-t border-warm-border/30" />
          <SessionList />
        </>
      )}

      <div className={cn('p-3 shrink-0', isChat && 'mt-auto')}>
